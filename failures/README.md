...
**Decision:** Reject subprocess-per-request ([ADR-003](../archive/architecture/adrs/ADR-003-python-subprocess.md)). Ship a **warm analyzer** on port 8766 ([ADR-004](../archive/architecture/adrs/ADR-004-long-running-analyzer.md)).
...
|-----------|-------------------|------------------|
| May–Jun | Subprocess import ~7–8s | [latency investigation](../investigations/latency-investigation/), [ADR-003](../archive/architecture/adrs/ADR-003-python-subprocess.md) |
