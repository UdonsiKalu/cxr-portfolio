...
| **Rarely** | [archive/architecture/adrs/](archive/architecture/adrs/) · [reliability/SLO.md](reliability/SLO.md) |
...
| [archive/architecture/adrs/](archive/architecture/README.md) | Decision records (ADRs only) |
...
- [latency investigation](investigations/latency-investigation/) · [ADR-004](archive/architecture/adrs/ADR-004-long-running-analyzer.md)
