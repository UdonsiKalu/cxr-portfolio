...
| **reliability/incidents/** | Complete | INC-001, INC-002-jaeger-trace-ux, INC-003 + splits |
| **reliability/chaos-experiments/** | Planned runs | Procedures drafted; execute before claiming game-day |
| **reliability/runbooks/** | Complete | slow-api, no-traces, restart, qdrant, ollama |
| **operations/** | Complete | docker, ci-cd, K8/tf reference copies |
| **security-compliance/** | Complete | Bootcamp-appropriate policies |
