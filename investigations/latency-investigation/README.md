...
![Jaeger search — POST traces ~5.6s / ~11s before fix](./assets/before-jaeger-search-2026-05-30.png)
...
![Jaeger waterfall — 11s trace, 5 spans](./assets/before-jaeger-waterfall-11s-5spans-2026-05-30.png)

### Correlating Locust and Jaeger

Side-by-side view: Jaeger linked trace **~10.8s**, Locust p95 **~12s** — same story from two lenses:

![Jaeger + Locust combined — ~10s before fix](./assets/before-jaeger-locust-combined-10s-2026-06-01.png)
...
![Jaeger — python.module_import ~7.7s + context_builder ~1.5s](./assets/before-jaeger-python-module-import-7s-2026-06-01.png)
...
Decision record: [ADR-004](../../architecture/adrs/ADR-004-long-running-analyzer.md) · Incident: [INC-003](../incidents/INC-003-python-import-bottleneck/postmortem.md)
...
![Jaeger — warm analyzer ~154ms, 22 spans](./assets/after-jaeger-locust-154ms-22spans-2026-06-02.png)

### Warm path — ~708ms

Kernel spans (`context_builder`, retrieval, etc.) under the analyzer service:

![Jaeger — warm path ~708ms](./assets/after-jaeger-locust-warm-708ms-2026-06-02.png)
...
![Jaeger — analyzer startup imports ~8s once](./assets/after-analyzer-startup-imports-8s-2026-06-02.png)
...
| Document | Role |
|----------|------|
| [Load testing report](../load-testing/) | Locust setup, p95 table, how to read with Jaeger |
| [INC-003 postmortem](../incidents/INC-003-python-import-bottleneck/postmortem.md) | Incident record |
| [INC-002 postmortem](../incidents/INC-002-jaeger-trace-ux/postmortem.md) | Trace profile rollback (`minimal` → `detailed`) |
| [Jaeger guide](../jaeger.md) | How to read CXR traces |
...
| Phase | File |
|-------|------|
| Before — Jaeger search | [before-jaeger-search-2026-05-30.png](./assets/before-jaeger-search-2026-05-30.png) |
| Before — 11s waterfall | [before-jaeger-waterfall-11s-5spans-2026-05-30.png](./assets/before-jaeger-waterfall-11s-5spans-2026-05-30.png) |
| Before — module import | [before-jaeger-python-module-import-7s-2026-06-01.png](./assets/before-jaeger-python-module-import-7s-2026-06-01.png) |
| Before — Jaeger + Locust | [before-jaeger-locust-combined-10s-2026-06-01.png](./assets/before-jaeger-locust-combined-10s-2026-06-01.png) |
...
| After — 154ms / 22 spans | [after-jaeger-locust-154ms-22spans-2026-06-02.png](./assets/after-jaeger-locust-154ms-22spans-2026-06-02.png) |
| After — warm ~708ms | [after-jaeger-locust-warm-708ms-2026-06-02.png](./assets/after-jaeger-locust-warm-708ms-2026-06-02.png) |
| After — startup ~8s | [after-analyzer-startup-imports-8s-2026-06-02.png](./assets/after-analyzer-startup-imports-8s-2026-06-02.png) |

Legacy filenames: `SW11-jaeger-*.png` in `./assets/` (aliases for first two before images).
