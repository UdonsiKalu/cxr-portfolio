# Failure screenshots (file catalog)

Narrative write-up for reviewers: **[failures/README.md](../../../../failures/README.md)** — read that first.

This folder holds Grafana captures for arcs 2–5 (OBS-001, Jun 18 regressions, GATE-002 tuner, etc.). PERF-008 screenshots live in [../perf008/](../perf008/README.md).
