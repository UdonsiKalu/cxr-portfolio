...
| Study | Doc | Evidence |
|-------|-----|----------|
| GATE-002 | [GATE-002-keda-helm-grid-study.md](GATE-002-keda-helm-grid-study.md) | [results/tuner/](../results/tuner/) |
...
| OBS-003 | [OBS-003-shared-sql-connection.md](OBS-003-shared-sql-connection.md) | [perf009 replay](../evidence/perf009/) · [cxr-platform PR #3](https://github.com/UdonsiKalu/cxr-platform/pull/3) |
